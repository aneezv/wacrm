        ...
        {loading || !contact ? (
          ...
          <div className="flex flex-col h-full">
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-muted/50 border-b border-border mx-4 mt-3 flex flex-wrap gap-1 group-data-horizontal/tabs:h-auto">
                <TabsTrigger
                  value="details"
                  className="h-auto data-active:bg-muted data-active:text-primary text-muted-foreground"
                >
                  {t('tabs.details')}
                </TabsTrigger>
                <TabsTrigger
